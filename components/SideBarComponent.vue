...
<template>
    <div :class="[getContainerCss]">
        <div class="fixed lg:relative z-50 border-r-1 border-primaryBorder">
            ...
            <div
                :class="[
                    'overflow-hidden transition-all duration-500 bg-secondaryBg h-screen lg:w-[200px] xl:w-[280px] lg:border-r lg:border-primaryBorder flex flex-col items-start justify-between pb-6',
                    containerDisplayCss,
                ]"
            >
                <div
                    class="w-full min-w-[200px] lg:flex lg:flex-col lg:justify-start lg:items-start"
                >
                    <div
                        class="font-lg text-xl text-primaryColor my-4 mx-14 lg:mx-4"
                    >
                        Kahera POS
                    </div>
                    <div class="h-10"></div>
