...
<template>
    <div class="w-full bg-white lg:border lg:border-primaryBorder rounded-xl p-6">
        <div @click="fileInputClick"
            ...
            <button v-if="!getFileUpload" class="p-2 text-secondaryText">Browse Files (.xlsx, .xls, & .csv)</button>
        ...
        <PrimaryButton label="Import" :loading="isLoading"
            class="w-full h-[55px] mt-4 rounded-xl border border-primaryBorder bg-secondaryColor py-2 px-3 flex justify-center items-center gap-2 text-white"
