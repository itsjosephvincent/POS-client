...
<template>
    <div class="w-[calc(90%)] max-w-96 h-12 bg-secondaryBg rounded-xl border border-secondaryBorder flex items-center px-4 my-4">
        ...
        <input :type="type" :name="props.name" :id="props.name" :placeholder="props.placeholder" class="grow ml-2 w-3/4 border-0 outline-0 text-secondaryText bg-secondaryBg text-xs">
