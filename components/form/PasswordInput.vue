    ...
    <div class="w-full">
        ...
        <div :class="['relative h-12 rounded-xl flex items-center bg-primaryBg border border-primaryBorder',]">
            ...
            <input :value="props.modelValue" @input="$emit('update:modelValue', $event.target.value)" :type="type"
                ...
                :class="['grow border-0 outline-0 text-primaryText focus:border focus:border-secondaryColor focus:ring-1 focus:ring-sky-500 h-full w-full rounded-xl px-4 pr-[57px]', getBgClass, !showIcon ? '' : 'pl-[60px]']">
