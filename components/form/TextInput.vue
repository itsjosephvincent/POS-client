...
<template>
    <div class="w-full">
        ...
        <div :class="['relative h-12 rounded-xl flex items-center', getBgClass, getBorderClass]">
            <IconSvg v-if="props.icon" class="mr-4 absolute left-[10px]" :icon="props.icon" color="tertiaryText" size="2em" />
            ...
            <IconSvg v-if="props.postIcon" class="mr-4 absolute right-[10px]" :icon="props.postIcon" :color="props.iconColor || 'primaryText'" size="2em" />
        </div>
