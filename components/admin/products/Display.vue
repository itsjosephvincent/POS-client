...
async function fetchProduct() {
    try {
        ...
        const response = await productService.find(product_uuid, {})
...
<template>
    <div>
        ...
        <AdminProductsItemCard v-else :uuid="getUUID" :name="getName" :cost="getCost" :price="getPrice" :inventory="getInventory" :image="getImage" />
    </div>
</template>